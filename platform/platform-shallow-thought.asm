...
;==============================================================================
.alias SER_DATA  $4800                        ; Data register
.alias SER_ST    $4801                        ; Status register
.alias SER_CMD   $4802                        ; Command register
.alias SER_CTL   $4803                        ; Control register
.alias SER_RXFL  %00001000 ; Serial Receive full bit
...
.scope
                ...
                lda     #%00011110      ; 1 stop bit, 8 data bits, 19200 baud
                sta     SER_CTL
...
s_kernel_id:
        .byte "Tali Forth 2 default kernel for Shallow Thought", AscLF, 0
